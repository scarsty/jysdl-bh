...
extern int ov_open_mem(whole_mem_file *f,OggVorbis_File *vf,char *initial,long ibytes);
extern int ov_test_mem(whole_mem_file *f,OggVorbis_File *vf,char *initial,long ibytes);
